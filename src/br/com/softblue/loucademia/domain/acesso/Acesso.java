...
public class Acesso implements Serializable{
	...
	public String calcularDuracao() {
		...
		// Duration é uma classe Java que possui um método que calcula o tempo.
		Duration d = Duration.between(entrada, saida);
		
		//%02 serve para preencher com "zeros" a esquerda até ficar com o tamanho 2. E como é um número decial, é necessário colocar o "d".
		//Extrai a hora da duração "d.toHoursPart()".
